...
// All these samples are based off Camo-Onsie since it works good
...
const sampleReviewsMeta = {
  ...
  characteristics: {
    Fit: {
      id: 135219,
      value: '3.0285714285714286',
    },
    Length: {
      id: 135220,
      value: '3.0678571428571429',
    },
    Comfort: {
      id: 135221,
      value: '3.2989323843416370',
    },
    Quality: {
      id: 135222,
      value: '3.4785478547854785',
    },
  },
};

const server = setupServer(
  rest.get('/products/40344/related', (req, res, ctx) => res(ctx.json([40344]))),
  rest.get('/products/40344', (req, res, ctx) => res(ctx.json(sampleProduct))),
  rest.get('/products/40344/styles', (req, res, ctx) => res(ctx.json(sampleProductStyles))),
  rest.get('/reviews/meta?product_id=40344', (req, res, ctx) => res(ctx.json(sampleReviewsMeta))),
);

export {
  server, sampleProduct, sampleProductStyles, sampleReviewsMeta,
};
